...
layout: contents
language: en-us
title: k2hpx_da_get_length
short_desc: K2HASH PHP Extension - PHP Extension library for K2HASH
lang_opp_file: k2hpx_da_get_lengthja.html
lang_opp_word: To Japanese
prev_url: k2hpx_da_get_handle.html
prev_string: k2hpx_da_get_handle
top_url: k2hpx.html
top_string: k2hash Functions
next_url: k2hpx_da_get_offset.html
next_string: k2hpx_da_get_offset
---
...
## Parameters
- dahandle_res  
Specifies the k2h direct access file handle that [k2hpx_da_get_handle](k2hpx_da_get_handle.html) returns.
